...
for fidx,folder in enumerate(folders):
    ...
    #    if is_load_PT:
        ...
        serp_full,melt_full,serps_stable,times_full,boundwaters = get_serp_vc(files_hires,-1,"/"+folder)
        ...
        if fidx>1:
            ...
            if plot_melting:
                axL1.plot(distance,serp_full[1:len(distance)+1]/1e6,color="fuchsia",linewidth=2.0)
...
if plot_time_xaxis:
    boundwater_name = "/boundwater6_time"
else:
    boundwater_name = "/boundwater6_convergence"
