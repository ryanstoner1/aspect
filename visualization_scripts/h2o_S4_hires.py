...
folder3 = "/rc3_part_lookup_serp_morb_bas_h2o_1denslookup_1visclookup_cohes_1-MPa_freesurf_y_extent_1450km_sed_1km_pel4_smu0_02_cmu0_04_deserp_erase_res5_5_run18"
ids3 = ["03100"]
files3 = [os.getcwd()+folder3+"/solution/solution-"+id3+".npz" for id3 in ids3]

folder4 = "/rc3_part_lookup_serp_morb_bas_h2o_1denslookup_1visclookup_cohes_1-MPa_freesurf_y_extent_1450km_sed_1km_smu0_02_cmu0_04_deserp_erase_res6_5_run36_12"
ids4 = ["03100"]
...
for fidx,folder in enumerate(folders):
    ...
    #    if is_load_PT:
        ...
        file_pattern_hires = folder+"/"+"solution/solution-???00.npz"
...
if plot_time_xaxis:
    boundwater_name = "/S4_time"
else:
    boundwater_name = "/S4_convergence"
