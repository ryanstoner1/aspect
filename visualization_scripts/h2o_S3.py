...
folder4 = "/rc3_part_lookup_serp_morb_bas_h2o_1denslookup_1visclookup_cohes_1-MPa_freesurf_y_extent_1450km_sed_1km_pel4_smu0_06_cmu0_04_deserp_erase_res5_5_run38"
ids4 = ["03100"]
...
if plot_time_xaxis:
    boundwater_name = "/S3_time"
else:
    boundwater_name = "/S3_convergence"
