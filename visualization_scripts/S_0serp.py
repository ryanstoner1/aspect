...
def main():
    ...
    folder = "/rc3_part_lookup_serp_morb_bas_h2o_1denslookup_0visclookup_cohes_1-MPa_freesurf_y_extent_1450km_sed_1km_smu0_02_cmu0_04_deserp_erase_res5_5_run41"
    file_pattern = os.getcwd()+folder+"/"+"solution/solution-0[0,1,2,3]000.npz"
